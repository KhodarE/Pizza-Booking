    ...
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pizza = await _context.Pizza
                .SingleOrDefaultAsync(m => m.PizzaID == id);
            if (pizza == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("PizzaID,PizzaName,Price")] Pizza pizza)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var pizza = await _context.Pizza.SingleOrDefaultAsync(m => m.PizzaID == id);
            if (pizza == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PizzaID,PizzaName,Price")] Pizza pizza)
        {
            if (id != pizza.PizzaID)
            {
                return NotFound();
